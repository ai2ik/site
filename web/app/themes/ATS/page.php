        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
          ...
          <tr>
            <td colspan="2" valign="top" class="space2"><!-- start main content area -->
					...
					<p style="text-align:center;font-size:2em;font-style:italic;color:#1B3F8B;font-weight:bold;">Call <strong><span class="shadow">1-877-455-0055</span></strong> today.</p></td>
		          </tr>
        </table></td>
      </tr>
    </table></div></td> 
