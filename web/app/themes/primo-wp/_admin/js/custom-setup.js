	...
	jQuery(function() {
		...
		jQuery('#ewf-sidebars a').click(function(){
			var ajaxPath = siteURL+'/wp-admin/admin-ajax.php';
			var sidebar = jQuery(this).closest('li');
			
			jQuery.post( ajaxPath, { action:"ewf_delete_sidebar", id: jQuery(this).attr('rel') }, function(data){
