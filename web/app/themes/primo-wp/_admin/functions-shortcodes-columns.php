<?php
	...
	add_shortcode("col145", "ewf_sc_column_145");
	add_shortcode("col205", "ewf_sc_column_205");
	add_shortcode("col280", "ewf_sc_column_280");
	add_shortcode("col430", "ewf_sc_column_430");
	add_shortcode("col580", "ewf_sc_column_580");
	add_shortcode("col655", "ewf_sc_column_655"); 
	...
	function ewf_sc_column_145( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column_205( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column_280( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column_580( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column_430( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column_655( $atts, $content ){
		extract(shortcode_atts(array(
			"class" => null,
		), $atts));	
	...
	function ewf_sc_column( $atts, $content ){
		...
		$src = null;
		$size = array('145'=> null, '205'=> null, '280'=> null, '430'=>null, '580'=>null, '655'=>null);
		$class = null;
