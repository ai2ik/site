...
<?php if ( have_comments() ) : ?>
	...
	<div class="fixed">						
		<h5 class="blog-post-comments"><strong><?php echo get_comments_number().' '.__( 'COMMENTS', EWF_SETUP_THEME_DOMAIN ); ?></strong></h5>
	</div>
...
<h4><?php _e('Leave a Comment', EWF_SETUP_THEME_DOMAIN); ?></h4><br/>
